# -*- coding: utf-8 -*-
"""
This script uses a simple PI-controller with the bestest_hydronic_heat_pump scenario.
...
def run(plot=True, length=3600, step=300, start_time=0, warmup_period=0):
    ...
    if plot:                
        ...
        plt.savefig("temperature_pi.png", dpi=300, bbox_inches='tight')
        print("Plot saved as 'temperature_pi.png'")        
